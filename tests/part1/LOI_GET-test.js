...
var server = supertest.agent("http://localhost:8080/api/v1/lois");

describe("lois status code", function() {
...
describe("lois authroized", function() {
...
describe("GET /lois/search", function() {
